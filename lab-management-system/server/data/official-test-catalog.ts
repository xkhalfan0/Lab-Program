...
export const OFFICIAL_TEST_CATALOG: OfficialTest[] = [
  ...
  { category: "concrete", nameEn: "Foamed Concrete Test: Compressive Strength", nameAr: "فحص الخرسانة الرغوية: مقاومة الضغط", code: "CONC_FOAM", unitPrice: "15", unit: "kg/cm²", standardRef: "BS 1881-116", formTemplate: "concrete_foam", sortOrder: 50 },
  { category: "concrete", nameEn: "Foamed Concrete Test: Density", nameAr: "فحص الخرسانة الرغوية: الكثافة", code: "CONC_FOAM_DENSITY", unitPrice: "40", unit: "kg/m³", standardRef: "BS 1881-114", formTemplate: "concrete_foam", sortOrder: 51 },
  ...
  {
    category: "aggregates",
    nameEn: "Relative density and water absorption of coarse & fine aggregate",
    nameAr: "الكثافة النسبية وامتصاص الماء للركام الخشن والناعم",
    code: "AGG_SG",
    unitPrice: "75",
    unit: "—",
    standardRef: "BS 812-2 / ASTM C127 / C128",
