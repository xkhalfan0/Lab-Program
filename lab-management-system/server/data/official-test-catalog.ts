...
export const OFFICIAL_TEST_CATALOG: OfficialTest[] = [
  ...
  { category: "concrete", nameEn: "Foamed Concrete Test (Strength & Density)", nameAr: "فحص الخرسانة الرغوية (مقاومة وكثافة)", code: "CONC_FOAM", unitPrice: "15", unit: "kg/cm²", standardRef: "BS 1881-116 / BS 1881-114", formTemplate: "concrete_foam", sortOrder: 50 },
  ...
  { category: "concrete", nameEn: "Flexural Strength of Concrete Beams", nameAr: "قوة انحناء عتة خرسانية", code: "CONC_BEAM", unitPrice: "90", unit: "kN", standardRef: "BS EN 12390-5", formTemplate: "concrete_beam", sortOrder: 80 },
